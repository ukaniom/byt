...
public class Money implements Comparable {
	...
	public Boolean equals(Money other) {
		return amount == other.getAmount() && currency.equals(other.getCurrency());
	}
	...
	public Money add(Money other) {
	    Integer convertedAmount = other.currency.valueInThisCurrency(other.amount, currency);
	    return new Money(amount + convertedAmount, currency);
	}
